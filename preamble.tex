...
\usepackage[paperwidth=6in,paperheight=9in,top=0.25in,bottom=0.5in,left=0.38in,right=0.38in,bindingoffset=0.24in,includehead,headsep=7pt]{geometry}
...
\definecolor{versenumbercolor}{HTML}{909090} % 909090 - Grey
\definecolor{altchaptercolor}{HTML}{1C2D5C} % Unused, I think?
...
\newcommand{\inparch}[1]{%
  ...
  \ifoddpage
    ...
    \rightabsblock{13.68cm}{\textcolor{bookheadingcolor}{\textbf{\oldch{#1}}}}%
  \else
    \tikz[remember picture] \coordinate (here);%
    \rightabsblock{14.28cm}{\textcolor{bookheadingcolor}{\textbf{\oldch{#1}}}}%
  \fi
}
  ...
  \newenvironment{psalms}
    {
      \renewcommand{\ch}[2]{%
        ...
        \begin{center}
          ...
          \ifthenelse{\equal{##2}{}}%
            {}% If ##2 is blank, do nothing
            {\itshape{\textbf{\textcolor{bookheadingcolor}{(ΚΑΤΑ ΜΑΣΟΡΙΤΙΚΟΝ ##2)}}}}% If not blank, render the line
        \end{center}
      }
      \newcommand{\masch}[1]{%
      }
...
\usepackage{tocloft}
\setlength{\cftbeforepartskip}{1.68em}
