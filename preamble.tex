...
\newcommand{\inparch}[1]{%
  ...
  % This only works for left side margins
  % \marginnote[\textcolor{bookheadingcolor}{\textbf{\oldch{#1}}}]{}%

  % This one at least shows the chapter.  I could decide to alternate chapter sides...
  % \marginnote[\textcolor{bookheadingcolor}{\textbf{\oldch{#1}}}]{\textcolor{bookheadingcolor}{\textbf{\oldch{#1}}}}%
  
  % This also works, but only alternate sides as well.  Doesn't seem to work on John though
  % \marginpar[\textcolor{bookheadingcolor}{\textbf{#1}}]{\textcolor{bookheadingcolor}{\textbf{#1}}}%
