...
% \usepackage{etoolbox}
% \AtBeginEnvironment{quote}{\vspace{0\baselineskip}}
  ...
  {%
    ...
    \begin{list}{}%
      {%
        ...
        \setlength{\topsep}{1em}       % Space before block
        \setlength{\partopsep}{0pt}    % Extra space above block
      }%
    \item\relax
    \itshape                    % Italicize text
    % Locally redefine quote environment for this block
    \renewenvironment{quote}
      {\list{}{\rightmargin=1em \leftmargin=1em \topsep=0pt \partopsep=0pt}\item\relax}
      {\endlist}
  }
  {%
    \end{list}%
